...
//         <button className="accordion-button collapsed" type="button" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">
//                 {title}
//         </button>
//     </h2>
//     <div id={title.replace(/\s/g, '')} className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
//         <div className="accordion-body">
//             <div className='instr' dangerouslySetInnerHTML={createMarkup()} />
//             <div style={{textAlign: 'center'}}>
//             <div className="btn-group" role="group" aria-label="Basic checkbox toggle button group">
//                 <input type="checkbox" className="btn-check" id={title} autoComplete="off" value={title} />
