  ...
  return (
    <footer className="pt-24 pb-12">
      <div className="container flex flex-col md:flex-row justify-between gap-12 pt-20 border-t border-[#15171C] divide-y divide-gray md:divide-none">
        <div className="flex flex-col items-start gap-8 text-xl text-white">
          <a className="mb-2 text-2xl font-semibold [&.js-active]:text-bold" href="/">Главная</a>
        ...
        <div id="contacts" className="flex flex-col gap-10 pt-12 md:pt-0">
          <span className="text-2xl text-white font-semibold">Наши соц.сети:</span>
          ...
          <span className="text-xl text-white">Ⓒ 2024 Все права защищены.<br />DROPCLICK</span>
        </div>
      </div>
    </footer>
  )
